document.addEventListener("DOMContentLoaded", function () {
  ...
  Array.apply(null, document.querySelectorAll('a[href*="#"]'))
    ...
    .map(function (el) {
      el.addEventListener("click", function (ev) {
        document
          .getElementsByClassName("navmenu-burger")[0]
  ...
  var boxes = Array.apply(
      null,
      document.getElementsByClassName("track__info-btn")
    ),
    box,
    target;

  Array.apply(null, document.getElementsByClassName("inscription-btn")).map(
    function (btn) {
  ...
  function iframeResizer() {
    ...
    if (!iframe) return;
    var sf = window.innerWidth < 700 ? 0.9 : 1;
    ...
    if (iframe) {
      ...
      return function () {
        ...
        if (!document.body.classList.contains("is-phone")) {
          iframe.src =
            "https://player.vimeo.com/video/373351629?portrait=0&autoplay=0";
          ...
          iframe.src =
            "https://player.vimeo.com/video/373351629?portrait=1&autoplay=1";
  ...
  function onClickOff(ev) {
    if (!ev.srcElement.classList.contains("scroll-link")) {
      ...
      document
        .getElementsByClassName("navmenu-burger")[0]
        .addEventListener("click", toggleNavBurgerVisibility);
    }
  ...
  function toggleNavBurgerVisibility(ev) {
    ...
    document
      .getElementsByClassName("navmenu-burger")[0]
      .removeEventListener("click", toggleNavBurgerVisibility);
...
function onLoadWarnings() {
  ...
  document.getElementsByClassName(
    "warn-modal"
  )[0].innerHTML = `<div class="warn-modal__wrapper">
